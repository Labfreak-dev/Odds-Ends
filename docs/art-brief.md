...
brief covers the painted layer: **967 images** that put unique art on every
Rare-and-up card, because variants share their subject's painting
("Bald Eagle — Sketch Plate" wears the Bald Eagle). Raid Gear is
excluded — the raids are retired and their cards sleep unobtainable.
...
|---|---|---|---|
| 1 | Mythic | 38 | the fireworks moment — every player stares at these |
| 2 | Legendary | 37 | same |
| 3 | Epic | 104 | foil tiers complete |
| 4 | Rare | 788 | the long tail, any pace |

Total: 967 images ≈ 15–25MB at spec, lazy-loaded one file per flip.
